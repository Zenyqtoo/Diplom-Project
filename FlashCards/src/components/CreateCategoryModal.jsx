 ...
 *  - open: boolean
 *  - onClose: () => void
 *  - onCreated: (createdCategory) => void
 */
export default function CreateCategoryModal({ open, onClose, onCreated }) {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const created = await addCategory({ title: trimmed, color, cards: [] });
  ...
  return (
    ...
    >
      <div style={{ width: 560, maxWidth: "95%", background: "#fff", borderRadius: 12, padding: 16 }}>
